...
cd /d "%~dp0"
echo ============================================
echo  Baue RELEASE Version (klingeundgelinge.duckdns.org:55000)
echo ============================================
...
echo.
if exist "dist\release\ProjektRPG.exe" (
    echo  FERTIG ^> dist\release\ProjektRPG.exe
    echo  Diese Exe auf GitHub hochladen und an Tester schicken!
) else (
